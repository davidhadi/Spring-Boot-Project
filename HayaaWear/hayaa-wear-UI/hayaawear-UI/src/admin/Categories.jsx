...
const Categories = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-10 py-12 mt-6">
      ...
      <div className="mb-12 p-8 rounded-3xl bg-black/50 border border-yellow-600/40 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <input
            ...
            className="p-3 rounded-xl bg-black/60 text-white border border-yellow-600/40 focus:outline-none focus:ring-2 focus:ring-yellow-500"
          />
  ...
  <h3 className="absolute bottom-4 left-4 text-xl text-yellow-300 font-semibold">
    {cat.name}
      ...
      {categories.length === 0 && (
        <p className="text-gray-400 mt-8">No categories found.</p>
      )}
